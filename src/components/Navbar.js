...
<nav className={`navbar navbar-expand-lg bg-${props.mode} navbar-${props.mode}`}>
  ...
  <div className='container'>
    <Link className="navbar-brand" to="/">{props.titl}</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <div className="form-check form-switch text-dark" style={{marginLeft:'10px'}}>
        <input className="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" onClick={props.togglMode}/>
